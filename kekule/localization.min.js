!function (e) {
...
}(this), Kekule.LOCAL_RES = !0, Kekule.Localization.setCurrModule("general"), Kekule.Localization.addResource("ru", "Texts", {UNNAMED: "unnamed"}), Kekule.Localization.addResource("ru", "ErrorMsg", {
    ...
    Render: {
        GeneralConfigs: {TITLE_drawOpacity: "Opacity", DES_drawOpacity: "Opacity (between 0-1) to draw objects"},
        Render2DConfigs: {
    ...
    Widget: {BaseWidget: {TITLE_settingFacade: "General settings", DES_settingFacade: "General settings"}},
    ChemWidget: {
        ChemObjDisplayer: {
